<nav x-data="{ open: false }" class="bg-gray-100 border-b border-gray-300">
        ...
        <div class="flex justify-between h-12">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <h1 class="inline-flex items-center px-1 pt-1 text-xl font-medium leading-5 text-gray-900 focus:outline-none ">Sistema de Gestión y Control de Incidentes</h1>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-1 px-2 py-2 sm:px-3 lg:px-2">
        <div class="flex justify-between h-6">
            <div class="flex">
                <!-- Navigation Links -->
                <div class="hidden space-x-2 sm:-my-px sm:ms-1 sm:flex">
                    ...
                    <x-nav-link href="{{ route('incidentes') }}" :active="request()->routeIs('incidentes')">
                        {{ __('INCIDENTES') }}
                    </x-nav-link>
